...
public class RNCWebViewManager extends SimpleViewManager<WebView> {
  ...
  protected static class RNCWebViewClient extends WebViewClient {
    ...
    public Boolean urlStringLooksInvalid(String urlString) {
    ...
    public Boolean responseRequiresJSInjection(Response response) {
    ...
    public WebResourceResponse isInterceptRequest(WebView webView, WebResourceRequest request) {
      try {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
          ...
          if (response.code() == HttpURLConnection.HTTP_OK) {
            is = new InputStreamWithInjectedJS(is, reactWebView.injectedOnStartLoadingJS, charset);
          }
    ...
    public WebResourceResponse shouldInterceptRequest(WebView webView, WebResourceRequest request) {
      WebResourceResponse response = isInterceptRequest(webView,request);
      if (response != null) {
        return response;
      }
  ...
  //适应iOS WKWebView命名规范 start inject
